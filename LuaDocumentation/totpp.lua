...
---@field alpine integerNil (get/set - ephemeral) Returns the alpine movement multiplier if it is set, `nil` otherwise.
---@field railroad integerNil (get/set - ephemeral) Returns the railroad movement multiplier if it is set, `nil` otherwise.
---@field river integerNil (get/set - ephemeral) Returns the river movement multiplier if it is set, `nil` otherwise.
---@field road integerNil (get/set - ephemeral) Returns the road movement multiplier if it is set, `nil` otherwise.
