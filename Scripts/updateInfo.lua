...
checkFile('discreteEventsRegistrar',6)
checkFile('promotion',3,3)
checkFile('generalLibrary',14,14)
checkFile('changeRules',3,2)
checkFile('navy',2,2)
