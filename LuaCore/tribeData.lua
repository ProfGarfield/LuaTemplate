...
function tribeData.defineFlag(flagName,defaultValue,resetTime)
end
...
---@param defaultValue? boolean If the underlying stored value is nil, this is the value the flag takes on. Defaults to false.
---@param resetTime? "never"|"onTurn"|"onTribeTurnBegin"|"onTribeTurnEnd"|"custom" Gives the time when the flag's stored value is reset to nil. Defaults to "never".
function tribeData.defineModuleFlag(moduleName,flagName,defaultValue,resetTime)
end
...
---@overload fun(tribe:tribeObject,flagName:string):boolean
---@return boolean The value associated with the `tribe`'s flag of `flagName`.
function tribeData.flagGetValue(tribe,flagName,moduleName)
...
---@overload fun(tribe:tribeObject,flagName:string)
function tribeData.flagSetTrue(tribe,flagName,moduleName)
end
...
---@param moduleName? string
---@overload fun(tribe:tribeObject,flagName:string)
function tribeData.flagSetFalse(tribe,flagName,moduleName)
end
...
---@param value boolean
---@param moduleName? string
function tribeData.flagSetValue(tribe,flagName,value,moduleName)
end
...
---@param moduleName? string
---@overload fun(tribe:tribeObject,flagName:string)
function tribeData.flagReset(tribe,flagName,moduleName)
end
...
---@overload fun(tribe:tribeObject,flagName:string):boolean
---@return boolean
function tribeData.flagIsNil(tribe,flagName,moduleName)
---@diagnostic disable-next-line: missing-return
end
...
---@param updateParameter? number|nil|function if update is "increment","incrementAll", "set", "setAll" then this must be a number. if update is "none" or "reset", this is ignored and can be nil. if update is "function", this is a function(numberOrNil,tribeID) -> numberOrNil. Default is nil.
...
function tribeData.defineCounter(counterName,defaultValue,minValue,maxValue,update,updateTime,updateParameter,nonInteger)
end
...
---@param updateParameter? number|nil|function if update is "increment","incrementAll", "set", "setAll" then this must be a number. if update is "none" or "reset", this is ignored and can be nil. if update is "function", this is a function(numberOrNil,tribeID) -> numberOrNil. Default is nil.
---@param nonInteger? boolean|nil if true, the counter can take on non-integer values. if false, the value is rounded using math.floor(initialValue+0.5). if nil, an error is thrown when the counter is set to a non-integer value. Default is nil.
function tribeData.defineModuleCounter(moduleName,counterName,defaultValue,minValue,maxValue,update,updateTime,updateParameter,nonInteger)
end
...
---@param moduleName? string
---@overload fun(tribe:tribeObject,counterName:string)
---@return number
function tribeData.counterGetValue(tribe,counterName,moduleName)
end
...
---@param value number
---@param moduleName? string
---@overload fun(tribe:tribeObject,counterName:string,value:number)
---@return number
function tribeData.counterSetValue(tribe,counterName,value,moduleName)
end
...
---@param moduleName? string
---@overload fun(tribe:tribeObject,counterName:string,increment:number,minValue:number,maxValue:number):number
---@overload fun(tribe:tribeObject,counterName:string,increment:number):number
---@return number
function tribeData.counterAdd(tribe,counterName,increment,minValue,maxValue,moduleName)
---@diagnostic disable-next-line: missing-return
end
...
---@overload fun(tribe:tribeObject,counterName:string,increment:number):number
---@return number
function tribeData.counterSubtract(tribe,counterName,increment,minValue,maxValue,moduleName)
---@diagnostic disable-next-line: missing-return
end
...
---@param maxValue? number
---@param moduleName? string
---@overload fun(tribe:tribeObject,counterName:string,minValue:number,maxValue:number):number
---@return number
function tribeData.counterSetWithin(tribe,counterName,minValue,maxValue,moduleName)
---@diagnostic disable-next-line: missing-return
end
...
---@param moduleName? string
---@overload fun(tribe:tribeObject,counterName:string,threshold:number):boolean
---@return boolean
function tribeData.counterIsAtLeast(tribe,counterName,threshold,moduleName)
---@diagnostic disable-next-line: missing-return
end
...
---@overload fun(tribe:tribeObject,counterName:string,threshold:number):boolean
---@return boolean
function tribeData.counterIsAtMost(tribe,counterName,threshold,moduleName)
---@diagnostic disable-next-line: missing-return
end
...
---@overload fun(tribe:tribeObject,counterName:string)
---@return void
function tribeData.counterReset(tribe,counterName,moduleName)
end
...
---@param counterName string
---@param moduleName? string
---@overload fun(tribe:tribeObject,counterName:string):boolean
---@return boolean
function tribeData.counterIsNil(tribe,counterName,moduleName)
---@diagnostic disable-next-line: missing-return
end
...
function tribeData.definePhrase(phraseName,defaultValue,resetTime,allowedValuesTable)
end
...
---@param resetTime? "never"|"onTurn"|"onTribeTurnBegin"|"onTribeTurnEnd"|"custom" Gives the time when the phrase's stored value is reset to nil.
---@param allowedValuesTable? table The allowed values for the phrase. If nil, no restrictions.
function tribeData.defineModulePhrase(moduleName,phraseName,defaultValue,resetTime,allowedValuesTable)
end
...
---@param moduleName? string
---@overload fun(tribe:tribeObject,phraseName:string):string
---@return string
function tribeData.phraseGetValue(tribe,phraseName,moduleName)
---@diagnostic disable-next-line: missing-return
end
...
---@param value string
---@param moduleName? string
---@overload fun(tribe:tribeObject,phraseName:string,value:string):void
function tribeData.phraseSetValue(tribe,phraseName,value,moduleName)
end
...
---@param phraseName string
---@param moduleName? string
---@overload fun(tribe:tribeObject,phraseName:string):void
function tribeData.phraseReset(tribe,phraseName,moduleName)
end
...
---@param phraseName string
---@param moduleName? string
---@overload fun(tribe:tribeObject,phraseName:string):boolean
---@return boolean
function tribeData.phraseIsNil(tribe,phraseName,moduleName)
---@diagnostic disable-next-line: missing-return
end
...
---@param updateFunction? fun(value:any,tribeID:number):any
function tribeData.defineGeneric(dataName,updateTime,updateAll,updateFunction)
end
...
---@param updateAll? boolean
---@param updateFunction? fun(value:any,tribeID:number):any
function tribeData.defineModuleGeneric(moduleName,dataName,updateTime,updateAll,updateFunction)
end
...
---@param moduleName? string
---@overload fun(tribe:tribeObject,keyName:string):any
---@return any
function tribeData.genericGetValue(tribe,keyName,moduleName)
end
...
---@param value any
---@param moduleName? string
---@overload fun(tribe:tribeObject,keyName:string,value:any):any
---@return any
function tribeData.genericSetValue(tribe,keyName,value,moduleName)
end
...
---@param key? string
---@param moduleName? string
---@overload fun(tribe:tribeObject,time:"onTurn"|"onTribeTurnBegin"|"onTribeTurnEnd"|"custom",tribe:number,key:string)
function tribeData.update(tribe,time,tribe,key,moduleName)
end
...
function tribeData.generalUpdate(time,tribe)
end
...
---@param oldtribe tribeObject
---@param newtribe tribeObject
function tribeData.transferData(oldtribe,newtribe)
end
...
---@param oldTribe tribeObject
---@param newTribe tribeObject|nil
function tribeData.transferOrDeleteData(oldTribe,newTribe)
end


--Deletes the data associated with the tribe.
---@param tribe tribeObject
function tribeData.deleteData(tribe)
end
...
---@param tribe tribeObject
function tribeData.validate(tribe)
end


--Replaces existing values of the sameItemCheck with new ones.
---@param tribe tribeObject
function tribeData.changeValidationInfo(tribe)
end
...
tribeData = supplementalData.buildModuleFunctions("tribeData","tribe",
